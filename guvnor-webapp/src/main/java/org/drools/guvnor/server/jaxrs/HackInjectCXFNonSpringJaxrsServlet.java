...
public class HackInjectCXFNonSpringJaxrsServlet extends CXFNonSpringJaxrsServlet {
    ...
    @Override
    protected Object createSingletonInstance(Class<?> cls, Map<String, String> map, ServletConfig sc) throws ServletException {
        Object singletonInstance = super.createSingletonInstance(cls, map, sc);
