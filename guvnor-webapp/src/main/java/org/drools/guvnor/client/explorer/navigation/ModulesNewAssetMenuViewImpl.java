...
public class ModulesNewAssetMenuViewImpl implements ModulesNewAssetMenuView {
    ...
    public void openNewPackageWizard() {
        NewPackageWizard wiz = new NewPackageWizard( new Command() {
            public void execute() {
                // TODO: Should work with EVentBus -Rikkola-
//                                manager.refreshTree();
            }
        } );
        wiz.show();
    ...
    private void openWizard( String format, boolean showCategories ) {
        NewAssetWizard pop = new NewAssetWizard( new OpenItemCommand() {
            // TODO: Remove this and use EventBus -Rikkola-
            ...
            public void open( MultiViewRow[] rows ) {
                for (MultiViewRow row : rows) {
                    TabContainer.getInstance().openAsset( row.uuid );
                }
            }
        },
                showCategories,
