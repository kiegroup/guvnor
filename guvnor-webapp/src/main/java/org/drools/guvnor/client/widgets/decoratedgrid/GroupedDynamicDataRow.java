...
public class GroupedDynamicDataRow extends DynamicDataRow {
    ...
    public void ensureCapacity(int minCapacity) {
        ...
        for ( DynamicDataRow groupedRow : this.groupedRows ) {
            groupedRow.ensureCapacity( minCapacity );
        }
    }
    ...
    @Override
    public boolean addAll(Collection< ? extends CellValue< ? extends Comparable< ? >>> c) {
        for ( DynamicDataRow groupedRow : this.groupedRows ) {
            groupedRow.addAll( c );
        }
    ...
    public boolean addAll(int index,
                          Collection< ? extends CellValue< ? extends Comparable< ? >>> c) {
        for ( DynamicDataRow groupedRow : this.groupedRows ) {
            groupedRow.addAll( index,
                               c );
        }
