...
public class SetColumnVisibilityEvent extends GwtEvent<SetColumnVisibilityEvent.Handler> {
    ...
    public static Type<SetColumnVisibilityEvent.Handler> TYPE = new Type<SetColumnVisibilityEvent.Handler>();
    ...
    @Override
    public Type<SetColumnVisibilityEvent.Handler> getAssociatedType() {
        return TYPE;
    }
