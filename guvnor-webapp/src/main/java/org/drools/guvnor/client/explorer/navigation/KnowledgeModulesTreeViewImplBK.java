...
public class KnowledgeModulesTreeViewImplBK extends NavigationItemBuilderOld
        implements
    ...
    public KnowledgeModulesTreeViewImplBK( ClientFactory clientFactory ) {
...
//
//                String uuid = pc.uuid;
//                clientFactory.getPlaceController().goTo( new ModuleEditorPlace( uuid ) );

            } else if ( userObject instanceof String[] ) {
                // This code is called when any of the package sub tree items is selected.
    ...
    public void onOpen( OpenEvent<TreeItem> event ) {
        ...
        if ( userObject != null && userObject instanceof String && "rootNode".equals( userObject ) ) {
            node.removeItems();
