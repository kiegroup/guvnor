...
public class UpdateColumnDefinitionEvent extends GwtEvent<UpdateColumnDefinitionEvent.Handler> {
    ...
    public static Type<UpdateColumnDefinitionEvent.Handler>           TYPE = new Type<UpdateColumnDefinitionEvent.Handler>();
    ...
    @Override
    public Type<UpdateColumnDefinitionEvent.Handler> getAssociatedType() {
        return TYPE;
    }
