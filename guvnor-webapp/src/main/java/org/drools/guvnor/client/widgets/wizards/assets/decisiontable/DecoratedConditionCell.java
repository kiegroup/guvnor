...
/**
 * A cell to display a Condition, wrapped to be able to change its appearance
 * when the Condition definition is incomplete
 */
class DecoratedConditionCell extends AbstractCell<DecoratedCondition> {
    ...
    private String getCssStyleName(DecoratedCondition cw) {
        if ( !cw.isDefinitionComplete() ) {
