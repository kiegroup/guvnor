...
public class ActionWorkItemSetColumnPopup extends FormStylePopup {
    ...
    public ActionWorkItemSetColumnPopup(final SuggestionCompletionEngine sce,
        ...
        setTitle( constants.ColumnConfigurationWorkItemSetColumn() );
        setModal( false );
