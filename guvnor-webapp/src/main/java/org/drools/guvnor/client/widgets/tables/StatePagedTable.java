...
public class StatePagedTable extends AbstractAssetPagedTable<StatePageRow> {
    ...
    protected void doCellTable() {
        ...
        ProvidesKey<StatePageRow> providesKey = new ProvidesKey<StatePageRow>() {
            public Object getKey( StatePageRow row ) {
                return row.getUuid();
            }
        };

        cellTable = new CellTable<StatePageRow>( providesKey );
        selectionModel = new MultiSelectionModel<StatePageRow>( providesKey );
        cellTable.setSelectionModel( selectionModel );
        SelectionColumn.createAndAddSelectionColumn( cellTable );

        ColumnPicker<StatePageRow> columnPicker = new ColumnPicker<StatePageRow>( cellTable );
        SimpleSortableHeaderGroup<StatePageRow> sortableHeaderGroup = new SimpleSortableHeaderGroup<StatePageRow>( cellTable );

        final TextColumn<StatePageRow> uuidNumberColumn = new TextColumn<StatePageRow>() {
            public String getValue( StatePageRow row ) {
                return row.getUuid();
            }
        };
        columnPicker.addColumn( uuidNumberColumn,
                                new SimpleSortableHeader<StatePageRow, String>( sortableHeaderGroup,
                                                                                constants.uuid(),
                                                                                uuidNumberColumn ),
                                false );
        ...
        Column<StatePageRow, String> openColumn = new Column<StatePageRow, String>( new ButtonCell() ) {
            public String getValue( StatePageRow row ) {
                return constants.Open();
            }
        };
        openColumn.setFieldUpdater( new FieldUpdater<StatePageRow, String>() {
    ...
    protected void addAncillaryColumns( ColumnPicker<StatePageRow> columnPicker,
                                        AbstractSortableHeaderGroup<StatePageRow> sortableHeaderGroup ) {

        Column<StatePageRow, ComparableImage> formatColumn = new Column<StatePageRow, ComparableImage>( new ComparableImageCell() ) {

            public ComparableImage getValue( StatePageRow row ) {
        ...
        columnPicker.addColumn( formatColumn,
                                new SimpleSortableHeader<StatePageRow, ComparableImage>( sortableHeaderGroup,
                                                                                         constants.Format(),
                                                                                         formatColumn ),
                                true );
        ...
        columnPicker.addColumn( titleColumn,
                                new SimpleSortableHeader<StatePageRow, TitledText>( sortableHeaderGroup,
                                                                                    constants.Name(),
                                                                                    titleColumn ),
                                true );
        ...
        Column<StatePageRow, Date> lastModifiedColumn = new Column<StatePageRow, Date>( new DateCell( DateTimeFormat.getFormat(
        ...
        columnPicker.addColumn( lastModifiedColumn,
                                new SimpleSortableHeader<StatePageRow, Date>( sortableHeaderGroup,
