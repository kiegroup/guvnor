...
public class ExplorerNodeConfig {
    ...
    private static void doCategoryNode(final TreeItem treeItem,
        ...
        RepositoryServiceFactory.getCategoryService().loadChildCategories( path,
                                                                           createGenericCallbackForLoadChildCategories( treeItem,
                                                                                                                        path,
                                                                                                                        itemWidgets ) );
    }
    ...
    private static GenericCallback<String[]> createGenericCallbackForLoadChildCategories(final TreeItem treeItem,
        ...
        return new GenericCallback<String[]>() {
            ...
            private void createChildNodes(final TreeItem treeItem,
                                          final String path,
                                          final Map<TreeItem, String> itemWidgets,
                                          String[] value) {
                for ( int i = 0; i < value.length; i++ ) {
                    ...
                    childNode.getTree().addOpenHandler( createOpenHandlerForTree( itemWidgets,
                                                                                  childNode ) );
                }
            }
