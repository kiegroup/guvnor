...
public class GuvnorSimplePager_Resources_default_InlineClientBundleGenerator implements org.drools.guvnor.client.widgets.tables.GuvnorSimplePager.Resources {
  private static GuvnorSimplePager_Resources_default_InlineClientBundleGenerator _instance0 = new GuvnorSimplePager_Resources_default_InlineClientBundleGenerator();
  ...
  private void simplePagerNextPageInitializer() {
    simplePagerNextPage = new com.google.gwt.resources.client.impl.ImageResourcePrototype(
      "simplePagerNextPage",
      com.google.gwt.i18n.client.LocaleInfo.getCurrentLocale().isRTL() ?externalImage_rtl5 : externalImage5,
      0, 0, 19, 19, false, false
    );
  }
  ...
  private void simplePagerNextPageDisabledInitializer() {
    simplePagerNextPageDisabled = new com.google.gwt.resources.client.impl.ImageResourcePrototype(
      ...
      com.google.gwt.i18n.client.LocaleInfo.getCurrentLocale().isRTL() ?externalImage_rtl6 : externalImage6,
      0, 0, 19, 19, false, false
    );
  }
  ...
  private void simplePagerPreviousPageInitializer() {
    simplePagerPreviousPage = new com.google.gwt.resources.client.impl.ImageResourcePrototype(
      ...
      com.google.gwt.i18n.client.LocaleInfo.getCurrentLocale().isRTL() ?externalImage_rtl7 : externalImage7,
      0, 0, 19, 19, false, false
    );
  }
  ...
  private void simplePagerPreviousPageDisabledInitializer() {
    simplePagerPreviousPageDisabled = new com.google.gwt.resources.client.impl.ImageResourcePrototype(
      ...
      com.google.gwt.i18n.client.LocaleInfo.getCurrentLocale().isRTL() ?externalImage_rtl8 : externalImage8,
      0, 0, 19, 19, false, false
    );
  }
  ...
  private void simplePagerStyleInitializer() {
    simplePagerStyle = new org.drools.guvnor.client.widgets.tables.GuvnorSimplePager.Style() {
      ...
      public String getText() {
        return (".GFVQBORBDM{padding:" + ("4px"+ " " +"8px")  + ";text-align:" + ("center")  + ";}.GFVQBORBBM{padding:" + ("4px")  + ";cursor:" + ("pointer")  + ";cursor:" + ("hand")  + ";}.GFVQBORBCM{cursor:" + ("default")  + ";}");
      }
  ...
  private static class simplePagerStyleInitializer {
    ...
    static org.drools.guvnor.client.widgets.tables.GuvnorSimplePager.Style get() {
      return simplePagerStyle;
    }
  }
  public org.drools.guvnor.client.widgets.tables.GuvnorSimplePager.Style simplePagerStyle() {
  ...
  private static org.drools.guvnor.client.widgets.tables.GuvnorSimplePager.Style simplePagerStyle;
  ...
  private native ResourcePrototype getResourceNative(String name) /*-{
    switch (name) {
      case 'simplePagerFastForward': return this.@org.drools.guvnor.client.widgets.tables.GuvnorSimplePager.Resources::simplePagerFastForward()();
      case 'simplePagerFastForwardDisabled': return this.@org.drools.guvnor.client.widgets.tables.GuvnorSimplePager.Resources::simplePagerFastForwardDisabled()();
      case 'simplePagerFirstPage': return this.@org.drools.guvnor.client.widgets.tables.GuvnorSimplePager.Resources::simplePagerFirstPage()();
      case 'simplePagerFirstPageDisabled': return this.@org.drools.guvnor.client.widgets.tables.GuvnorSimplePager.Resources::simplePagerFirstPageDisabled()();
      case 'simplePagerLastPage': return this.@org.drools.guvnor.client.widgets.tables.GuvnorSimplePager.Resources::simplePagerLastPage()();
      case 'simplePagerLastPageDisabled': return this.@org.drools.guvnor.client.widgets.tables.GuvnorSimplePager.Resources::simplePagerLastPageDisabled()();
      case 'simplePagerNextPage': return this.@org.drools.guvnor.client.widgets.tables.GuvnorSimplePager.Resources::simplePagerNextPage()();
      case 'simplePagerNextPageDisabled': return this.@org.drools.guvnor.client.widgets.tables.GuvnorSimplePager.Resources::simplePagerNextPageDisabled()();
      case 'simplePagerPreviousPage': return this.@org.drools.guvnor.client.widgets.tables.GuvnorSimplePager.Resources::simplePagerPreviousPage()();
      case 'simplePagerPreviousPageDisabled': return this.@org.drools.guvnor.client.widgets.tables.GuvnorSimplePager.Resources::simplePagerPreviousPageDisabled()();
      case 'simplePagerStyle': return this.@org.drools.guvnor.client.widgets.tables.GuvnorSimplePager.Resources::simplePagerStyle()();
    }
    return null;
  }-*/;
}
