...
public class PerspectivesPanelViewImpl_PerspectivesPanelViewImplBinderImpl implements UiBinder<com.google.gwt.user.client.ui.Widget, org.drools.guvnor.client.perspective.PerspectivesPanelViewImpl>, org.drools.guvnor.client.perspective.PerspectivesPanelViewImpl.PerspectivesPanelViewImplBinder {
  ...
  interface Template extends SafeHtmlTemplates {
    ...
    @Template("<div class='{0}'> <img src='images/header_logo.gif'> </div> <div class='{1}'> <div class='{2}'> <small> " + "{3}" + " <span id='{4}'></span> <span id='{5}'></span> </small>  </div> <div class='{6}'> <span id='{7}'></span> </div> </div> <div style='clear:both;'></div>")
  ...
  public com.google.gwt.user.client.ui.Widget createAndBindUi(final org.drools.guvnor.client.perspective.PerspectivesPanelViewImpl owner) {
    ...
    com.google.gwt.user.client.ui.ListBox perspectives = (com.google.gwt.user.client.ui.ListBox) GWT.create(com.google.gwt.user.client.ui.ListBox.class);
    com.google.gwt.user.client.ui.HTMLPanel titlePanel = new com.google.gwt.user.client.ui.HTMLPanel(template.html2("" + guvnorResources.headerCss().logoClass() + "", "" + guvnorResources.headerCss().controlsClass() + "", "" + guvnorResources.headerCss().userInfoClass() + "", "" + i18n.WelcomeUser() + "", domId0, domId1, "" + guvnorResources.headerCss().perspectivesClass() + "", domId2).asString());
    ...
    perspectives.setMultipleSelect(false);
    perspectives.setVisibleItemCount(1);
    ...
    titlePanel.addAndReplaceElement(perspectives, domId2Element);
    ...
    final com.google.gwt.event.dom.client.ChangeHandler handlerMethodWithNameVeryUnlikelyToCollideWithUserFieldNames1 = new com.google.gwt.event.dom.client.ChangeHandler() {
      public void onChange(com.google.gwt.event.dom.client.ChangeEvent event) {
        owner.handleChange(event);
      }
    };
    perspectives.addChangeHandler(handlerMethodWithNameVeryUnlikelyToCollideWithUserFieldNames1);
    ...
    logoutAnchor.addClickHandler(handlerMethodWithNameVeryUnlikelyToCollideWithUserFieldNames2);

    owner.logoutAnchor = logoutAnchor;
    owner.perspectives = perspectives;
