  ...
  private void styleInitializer() {
    style = new org.drools.guvnor.client.common.StackItemHeaderViewImpl_HeaderHTMLBinderImpl_GenCss_style() {
      ...
      public String getText() {
        return com.google.gwt.i18n.client.LocaleInfo.getCurrentLocale().isRTL() ? ((".GFVQBORBHM{float:" + ("right")  + ";font-family:" + ("Arial"+ " " +"Unicode"+ " " +"MS"+ ","+ " " +"Arial"+ ","+ " " +"sans-serif")  + ";font-size:" + ("small")  + ";}")) : ((".GFVQBORBHM{float:" + ("left")  + ";font-family:" + ("Arial"+ " " +"Unicode"+ " " +"MS"+ ","+ " " +"Arial"+ ","+ " " +"sans-serif")  + ";font-size:" + ("small")  + ";}"));
      }
