...
public class DTColumnConfig52_FieldSerializer implements com.google.gwt.user.client.rpc.impl.TypeHandler {
  private static native java.lang.String getDefaultValue(org.drools.ide.common.client.modeldriven.dt52.DTColumnConfig52 instance) /*-{
    return instance.@org.drools.ide.common.client.modeldriven.dt52.DTColumnConfig52::defaultValue;
  }-*/;
  
  private static native void setDefaultValue(org.drools.ide.common.client.modeldriven.dt52.DTColumnConfig52 instance, java.lang.String value) 
  /*-{
    instance.@org.drools.ide.common.client.modeldriven.dt52.DTColumnConfig52::defaultValue = value;
  }-*/;
  ...
  public static void deserialize(SerializationStreamReader streamReader, org.drools.ide.common.client.modeldriven.dt52.DTColumnConfig52 instance) throws SerializationException {
    setDefaultValue(instance, streamReader.readString());
  ...
  public static void serialize(SerializationStreamWriter streamWriter, org.drools.ide.common.client.modeldriven.dt52.DTColumnConfig52 instance) throws SerializationException {
    streamWriter.writeString(getDefaultValue(instance));
