  ...
  private void cellTableStyleInitializer() {
    cellTableStyle = new com.google.gwt.user.cellview.client.CellTable.Style() {
      ...
      public String getText() {
        return com.google.gwt.i18n.client.LocaleInfo.getCurrentLocale().isRTL() ? ((".GFVQBORBID{border-top:" + ("2px"+ " " +"solid"+ " " +"#6f7277")  + ";padding:" + ("3px"+ " " +"15px")  + ";text-align:" + ("right")  + ";color:" + ("#4b4a4a")  + ";text-shadow:" + ("#ddf"+ " " +"1px"+ " " +"1px"+ " " +"0")  + ";overflow:" + ("hidden")  + ";}.GFVQBORBJD{border-bottom:" + ("2px"+ " " +"solid"+ " " +"#6f7277")  + ";padding:" + ("3px"+ " " +"15px")  + ";text-align:" + ("right")  + ";color:" + ("#4b4a4a")  + ";text-shadow:") + (("#ddf"+ " " +"1px"+ " " +"1px"+ " " +"0")  + ";overflow:" + ("hidden")  + ";}.GFVQBORBCD{padding:" + ("2px"+ " " +"15px")  + ";overflow:" + ("hidden")  + ";}.GFVQBORBHE{cursor:" + ("pointer")  + ";cursor:" + ("hand")  + ";}.GFVQBORBHE:hover{color:" + ("#6c6b6b")  + ";}.GFVQBORBDD{background:" + ("#fff")  + ";}.GFVQBORBED{border:" + ("2px"+ " " +"solid"+ " " +"#fff")  + ";}.GFVQBORBDE{background:" + ("#f3f7fb")  + ";}.GFVQBORBEE{border:" + ("2px"+ " " +"solid"+ " " +"#f3f7fb") ) + (";}.GFVQBORBKD{background:" + ("#eee")  + ";}.GFVQBORBLD{border:" + ("2px"+ " " +"solid"+ " " +"#eee")  + ";}.GFVQBORBND{background:" + ("#ffc")  + ";}.GFVQBORBOD{border:" + ("2px"+ " " +"solid"+ " " +"#ffc")  + ";}.GFVQBORBFE{background:" + ("#628cd5")  + ";color:" + ("white")  + ";height:" + ("auto")  + ";overflow:" + ("auto")  + ";}.GFVQBORBGE{border:" + ("2px"+ " " +"solid"+ " " +"#628cd5")  + ";}.GFVQBORBMD{border:" + ("2px"+ " " +"solid"+ " " +"#d7dde8")  + ";}.GFVQBORBCE{margin:") + (("30px")  + ";}")) : ((".GFVQBORBID{border-top:" + ("2px"+ " " +"solid"+ " " +"#6f7277")  + ";padding:" + ("3px"+ " " +"15px")  + ";text-align:" + ("left")  + ";color:" + ("#4b4a4a")  + ";text-shadow:" + ("#ddf"+ " " +"1px"+ " " +"1px"+ " " +"0")  + ";overflow:" + ("hidden")  + ";}.GFVQBORBJD{border-bottom:" + ("2px"+ " " +"solid"+ " " +"#6f7277")  + ";padding:" + ("3px"+ " " +"15px")  + ";text-align:" + ("left")  + ";color:" + ("#4b4a4a")  + ";text-shadow:") + (("#ddf"+ " " +"1px"+ " " +"1px"+ " " +"0")  + ";overflow:" + ("hidden")  + ";}.GFVQBORBCD{padding:" + ("2px"+ " " +"15px")  + ";overflow:" + ("hidden")  + ";}.GFVQBORBHE{cursor:" + ("pointer")  + ";cursor:" + ("hand")  + ";}.GFVQBORBHE:hover{color:" + ("#6c6b6b")  + ";}.GFVQBORBDD{background:" + ("#fff")  + ";}.GFVQBORBED{border:" + ("2px"+ " " +"solid"+ " " +"#fff")  + ";}.GFVQBORBDE{background:" + ("#f3f7fb")  + ";}.GFVQBORBEE{border:" + ("2px"+ " " +"solid"+ " " +"#f3f7fb") ) + (";}.GFVQBORBKD{background:" + ("#eee")  + ";}.GFVQBORBLD{border:" + ("2px"+ " " +"solid"+ " " +"#eee")  + ";}.GFVQBORBND{background:" + ("#ffc")  + ";}.GFVQBORBOD{border:" + ("2px"+ " " +"solid"+ " " +"#ffc")  + ";}.GFVQBORBFE{background:" + ("#628cd5")  + ";color:" + ("white")  + ";height:" + ("auto")  + ";overflow:" + ("auto")  + ";}.GFVQBORBGE{border:" + ("2px"+ " " +"solid"+ " " +"#628cd5")  + ";}.GFVQBORBMD{border:" + ("2px"+ " " +"solid"+ " " +"#d7dde8")  + ";}.GFVQBORBCE{margin:") + (("30px")  + ";}"));
      }
