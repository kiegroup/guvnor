...
public class ProjectTest {
    ...
    public void ProjectCanNotBeNull() throws Exception {
        new Project(mock(OrganizationalUnit.class),
                    null,
                    mock(Branch.class),
                    mock(Module.class));
    }
    ...
    public void getNameNoModule() throws Exception {
        ...
        final Project project = new Project(mock(OrganizationalUnit.class),
                                            repository,
                                            mock(Branch.class),
                                            null);
    ...
    public void requiresRefresh() throws Exception {
        ...
        assertTrue(project.requiresRefresh());

        project.markAsCached();

        assertFalse(project.requiresRefresh());
    }
}