...
public class ProjectServiceImplTest {
    ...
    public void getAllProjects() throws Exception {
        ...
        final Collection<Project> allProjects = projectService.getAllProjects();
    ...
    public void getAllProjectsForOU1() throws Exception {
        final Collection<Project> allProjects = projectService.getAllProjects(ou1);
    ...
    public void getAllProjectsForOU2() throws Exception {
        final Collection<Project> allProjects = projectService.getAllProjects(ou2);
    ...
    public void getAllProjectsForOU2WhenRepositoryListHasUpdated() throws Exception {
        ...
        final Collection<Project> allProjects = projectService.getAllProjects(new OrganizationalUnitImpl("ou2",
                                                                                                         "",
                                                                                                         ""));
    ...
    private void assertContains(final Repository repository,
                                final Collection<Project> allProjects) {

        for (final Project project : allProjects) {
            if (project.getRepository().equals(repository)) {
                return;
            }
        }
