...
//    }
    ...
    private BrowseTreeView setUpContentView( NavigationViewFactory navigationViewFactory ) {
        BrowseTreeView browseTreeView = Mockito.mock(BrowseTreeView.class);
    ...
    private BrowseHeaderView setUpHeaderView( NavigationViewFactory navigationViewFactory ) {
        BrowseHeaderView stackItemHeaderView = Mockito.mock(BrowseHeaderView.class);
        Mockito.when(navigationViewFactory.getBrowseHeaderView()).thenReturn( stackItemHeaderView );
