...
public class PackageHierarchyTest {
    ...
    public void testFlatNoSubPackages() {
        ...
        Assert.assertNotNull(ph.getRootFolder());
        ...
        Assert.assertEquals("foo.bar",
                f.getFolderName());
        Assert.assertNotNull(f.getPackageConfigData());
    ...
    public void testFlatWithSubPackages() {
        ...
        Assert.assertEquals("foo.bar",
                f1.getFolderName());
        Assert.assertNotNull(f1.getPackageConfigData());
        Assert.assertEquals(pc,
                f1.getPackageConfigData());

        //2nd child
        Folder f2 = ph.getRootFolder().getChildren().get( 1 );
        Assert.assertEquals("foo.bar.wee.yoo",
                f2.getFolderName());
        Assert.assertNotNull(f2.getPackageConfigData());
    ...
    public void testFlatWithSubPackages2() {
        ...
        Assert.assertEquals("foo.bar.wee.yoo.zee.goo",
                f3.getFolderName());
        Assert.assertNotNull(f3.getPackageConfigData());
        Assert.assertEquals(spc2,
    ...
    public void testNestedNoSubPackages() {
        ...
        Assert.assertEquals("foo",
                f1.getFolderName());
        Assert.assertNull(f1.getPackageConfigData());
    ...
    public void testNestedWithSubPackages() {
        ...
        Assert.assertEquals("wee",
                f3.getFolderName());
        Assert.assertNull(f3.getPackageConfigData());

        //4th child
        Assert.assertEquals(1,
                f3.getChildren().size());
        Folder f4 = f3.getChildren().get( 0 );
        Assert.assertEquals("yoo",
                f4.getFolderName());
        Assert.assertEquals(spc,
    ...
    public void testNestedWithSubPackages2() {
        ...
        Assert.assertEquals("zee",
                f5.getFolderName());
        Assert.assertNull(f5.getPackageConfigData());
