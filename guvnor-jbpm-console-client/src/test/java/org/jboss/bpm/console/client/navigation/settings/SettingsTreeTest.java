...
public class SettingsTreeTest {
    ...
    public void setUp() throws Exception {
        view = Mockito.mock(SettingsTreeView.class);
    ...
    public void testGoToPreferences() throws Exception {
        ...
        Mockito.verify(placeController).goTo(Matchers.any(PreferencesPlace.class));
    }

    @Test
    public void testGoToSystem() throws Exception {
        presenter.onSystemSelected();
        Mockito.verify(placeController).goTo(Matchers.any(SystemPlace.class));
    }
}
