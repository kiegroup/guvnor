...
public class UploadFormPresenter implements UploadFormView.Presenter {
    ...
    @Inject
    public UploadFormPresenter(final UploadFormView view, Event<M2RepoSearchEvent> searchEvent,
    ...
    @Override
    public void handleSubmitComplete(SubmitCompleteEvent event) {
    ...
    @Override
    public void handleSubmit(SubmitEvent event) {
