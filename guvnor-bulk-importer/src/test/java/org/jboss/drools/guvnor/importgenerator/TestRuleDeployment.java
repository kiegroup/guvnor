...
public class TestRuleDeployment {
    ...
    //###############################################################################
    //Commented out whilst KIE refactoring is ongoing. This test, if Bulk Importer
    //even has any life after Drools 6.0, needs to be rewritten to use KnowledgeAgent
    //###############################################################################
