...
public class GuvnorStructureContext {
    ...
    private final HashMap<GuvnorStructureContextChangeHandler.HandlerRegistration, GuvnorStructureContextChangeHandler>             handlers             = new HashMap<GuvnorStructureContextChangeHandler.HandlerRegistration, GuvnorStructureContextChangeHandler>();
    private final HashMap<GuvnorStructureContextBranchChangeHandler.HandlerRegistration, GuvnorStructureContextBranchChangeHandler> branchChangeHandlers = new HashMap<GuvnorStructureContextBranchChangeHandler.HandlerRegistration, GuvnorStructureContextBranchChangeHandler>();
    private final HashMap<String, String>                                                                                           aliasBranch          = new HashMap<String, String>();
    ...
    private Collection<String> updateRepositories( final Collection<Repository> response ) {
        final Collection<String> foundAliases = new ArrayList<String>();
    ...
    private Collection<String> getMissingAliases( final Collection<String> foundAliases ) {
        final Collection<String> missingAliases = new ArrayList<String>();
