...
public class CloneRepositoryPresenter implements CloneRepositoryView.Presenter {
    ...
    @Inject
    public CloneRepositoryPresenter(RepositoryPreferences repositoryPreferences, CloneRepositoryView view,
                Caller<RepositoryService> repositoryService, Caller<OrganizationalUnitService> organizationalUnitService,
    ...
    private void populateOrganizationalUnits() {
        ...
        organizationalUnitService.call(
            new RemoteCallback<Collection<OrganizationalUnit>>() {
                @Override
