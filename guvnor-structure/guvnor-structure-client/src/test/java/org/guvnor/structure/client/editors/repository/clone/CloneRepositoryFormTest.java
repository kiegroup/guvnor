...
public class CloneRepositoryFormTest {
    ...
    public void testComponentsStaysOperational() {
        ...
        componentsLocked();
        verifyRepoClonedViewReaction(true);
        verifyRepoClonedBackendReaction(true);
    }
    ...
    public void testComponentsNonLockEmptyUrl() {
        ...
        verifyRepoClonedViewReaction(false);
        verifyRepoClonedBackendReaction(false);
    }
    ...
    private void verifyRepoClonedViewReaction(boolean cloned) {
        if(cloned) {
    ...
    private void verifyRepoClonedBackendReaction(boolean cloned) {
        if(cloned) {
            verify(repoService).createRepository(any(OrganizationalUnit.class), anyString(), anyString(), anyMap());
        } else {
            verify(repoService, never()).createRepository(any(OrganizationalUnit.class), anyString(), anyString(), anyMap());
        }
    }
}
