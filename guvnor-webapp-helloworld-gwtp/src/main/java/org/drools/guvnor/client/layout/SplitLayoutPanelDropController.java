 ...
 */
public class SplitLayoutPanelDropController extends AbstractInsertPanelDropController {
   ...
   */
  public SplitLayoutPanelDropController(SplitLayoutInsertPanel dropTarget) {
    super(dropTarget);
  }
