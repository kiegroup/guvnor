...
public class FactVerifierTest {
    ...
    private org.drools.ide.common.server.testscenarios.MockWorkingMemory workingMemory;

    @Before
    public void setUp() throws Exception {
        workingMemory = new org.drools.ide.common.server.testscenarios.MockWorkingMemory();
