...
public class SharedConstants
    ...
    //need to specify an implementation of "org.kie.ide.common.server.util.OperatorParameterBuilder" to construct
    //the necessary DRL from the parameters. This is the key name for the applicable class amongst the Parameters.
    public static final String OPERATOR_PARAMETER_GENERATOR = "org.kie.ide.common.server.util.BRDRLPersistence.operatorParameterGenerator";
