...
import org.drools.testframework.executors.MethodExecutor;
import org.drools.testframework.verifiers.FactVerifier;
import org.drools.testframework.verifiers.RuleFiredVerifier;
...
public class TestScenarioWorkingMemoryWrapper {
    ...
    public void verifyExpectation(Expectation expectation) {
        if (expectation instanceof VerifyFact) {
            ...
            if (eventListener.firingCounts != null) {
    ...
    private void resetEventListener() {
        ...
        this.ruleFiredVerifier.setFireCounter(eventListener.firingCounts);
    }
