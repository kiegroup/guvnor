...
public class CategoryExplorerWidget
    ...
    public void showEmptyTree() {
        if ( this.emptyCategories == null ) {
            ...
            p.add( new HTML( Constants.INSTANCE.NoCategoriesCreatedYetTip() ) );
            final Button b = new Button( Constants.INSTANCE.Refresh() );
    ...
    private void loadInitialTree() {
        navTreeWidget.addItem( Constants.INSTANCE.PleaseWait() );
