...
import static org.kie.guvnor.widgets.decoratedgrid.client.resources.GridResources.*;
...
public class CellHeightCalculatorImpl {
    ...
    public int calculateHeight( int rowSpan ) {
        int divHeight = ( INSTANCE.style().rowHeight() ) * rowSpan - INSTANCE.style().borderWidth();
        return divHeight;
    }
