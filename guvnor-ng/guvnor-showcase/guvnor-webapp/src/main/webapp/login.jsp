  ...
  <style type="text/css">
    * {
    ...
    body {
      ...
      pading: 0;
      color: #fff;
      background: url('<%=request.getContextPath()%>/org.kie.guvnor.GuvnorShowcase/images/bg-login.png') repeat #1b1b1b;
      font-size: 14px;
    ...
    #dummy {
      ...
      height: 250px;
      width: 100%;
      background: url('<%=request.getContextPath()%>/org.kie.guvnor.GuvnorShowcase/images/bg-login-top.png') repeat #fff;
      z-index: 1;
    }
...
<div id="login-wrapper" class="png_bg">
  <div id="login-top">
    <img src="<%=request.getContextPath()%>/org.kie.guvnor.GuvnorShowcase/images/uf_logo.png" alt="Logo" title="Powered By Uberfire"/>
  </div>
