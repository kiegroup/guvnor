...
public class ProjectServiceImplResolvePackageValidTest {
    ...
    public void testResolvePackageWithRootPath() throws Exception {
        ...
        final URL rootUrl = this.getClass().getResource( "/ProjectStructureValid" );
    ...
    public void testResolvePackageWithSrcPath() throws Exception {
        ...
        final URL rootUrl = this.getClass().getResource( "/ProjectStructureValid/src" );
        final org.kie.commons.java.nio.file.Path nioRootPath = fs.getPath( rootUrl.toURI() );
        final Path rootPath = paths.convert( nioRootPath );
    ...
    public void testResolvePackageWithMainPath() throws Exception {
        ...
        final URL rootUrl = this.getClass().getResource( "/ProjectStructureValid/src/main" );
        final org.kie.commons.java.nio.file.Path nioRootPath = fs.getPath( rootUrl.toURI() );
        final Path rootPath = paths.convert( nioRootPath );
    ...
    public void testResolvePackageDefaultJava() throws Exception {
        ...
        final URL rootUrl = this.getClass().getResource( "/ProjectStructureValid/src/main/java" );
        final org.kie.commons.java.nio.file.Path nioRootPath = fs.getPath( rootUrl.toURI() );
        final Path rootPath = paths.convert( nioRootPath );

        final URL testUrl = this.getClass().getResource( "/ProjectStructureValid/src/main/java" );
    ...
    public void testResolvePackageDefaultResources() throws Exception {
        ...
        final URL rootUrl = this.getClass().getResource( "/ProjectStructureValid/src/main/resources" );
        final org.kie.commons.java.nio.file.Path nioRootPath = fs.getPath( rootUrl.toURI() );
        final Path rootPath = paths.convert( nioRootPath );
    ...
    public void testResolvePackageWithJavaFileInDefaultPackage() throws Exception {
        ...
        final URL testUrl = this.getClass().getResource( "/ProjectStructureValid/src/main/java/Bean.java" );
        final org.kie.commons.java.nio.file.Path nioTestPath = fs.getPath( testUrl.toURI() );
        final Path testPath = paths.convert( nioTestPath );
    ...
    public void testResolvePackageWithJavaFileInSubPackage() throws Exception {
        ...
        final URL rootUrl = this.getClass().getResource( "/ProjectStructureValid/src/main/java/org/kie/test" );
        final org.kie.commons.java.nio.file.Path nioRootPath = fs.getPath( rootUrl.toURI() );
        final Path rootPath = paths.convert( nioRootPath );

        final URL testUrl = this.getClass().getResource( "/ProjectStructureValid/src/main/java/org/kie/test/Bean.java" );
        final org.kie.commons.java.nio.file.Path nioTestPath = fs.getPath( testUrl.toURI() );
        final Path testPath = paths.convert( nioTestPath );
    ...
    public void testResolvePackageWithResourcesFileInDefaultPackage() throws Exception {
        ...
        final URL testUrl = this.getClass().getResource( "/ProjectStructureValid/src/main/resources/rule1.drl" );
        final org.kie.commons.java.nio.file.Path nioTestPath = fs.getPath( testUrl.toURI() );
        final Path testPath = paths.convert( nioTestPath );
    ...
    public void testResolvePackageWithResourcesFileInSubPackage() throws Exception {
        ...
        final URL rootUrl = this.getClass().getResource( "/ProjectStructureValid/src/main/resources/org/kie/test" );
        final org.kie.commons.java.nio.file.Path nioRootPath = fs.getPath( rootUrl.toURI() );
        final Path rootPath = paths.convert( nioRootPath );

        final URL testUrl = this.getClass().getResource( "/ProjectStructureValid/src/main/resources/org/kie/test/rule1.drl" );
        final org.kie.commons.java.nio.file.Path nioTestPath = fs.getPath( testUrl.toURI() );
        final Path testPath = paths.convert( nioTestPath );
