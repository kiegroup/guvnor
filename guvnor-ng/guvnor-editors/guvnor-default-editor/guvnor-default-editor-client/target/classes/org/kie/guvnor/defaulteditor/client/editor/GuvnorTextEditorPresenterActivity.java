 ...
 */
public class GuvnorTextEditorPresenterActivity extends AbstractWorkbenchEditorActivity {
    ...
    @Inject
    private GuvnorTextEditorPresenter realPresenter;

    @Inject
    //Constructor injection for testing
    public GuvnorTextEditorPresenterActivity(final PlaceManager placeManager) {
        super( placeManager );
    }
    ...
    public String getSignatureId() {
        return "org.kie.guvnor.defaulteditor.client.editor.GuvnorTextEditorPresenterActivity";
    }
}
