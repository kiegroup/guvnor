...
@Identifier("GuidedScoreCardEditor")
@AssociatedResources({
    org.kie.guvnor.guided.scorecard.client.type.GuidedScoreCardResourceType.class
})
 ...
 */
public class GuidedScoreCardEditorPresenterActivity extends AbstractWorkbenchEditorActivity {
    ...
    @Inject
    private GuidedScoreCardEditorPresenter realPresenter;

    @Inject
    //Constructor injection for testing
    public GuidedScoreCardEditorPresenterActivity(final PlaceManager placeManager) {
        super( placeManager );
    }
    ...
    public String getSignatureId() {
        return "org.kie.guvnor.guided.scorecard.client.editor.GuidedScoreCardEditorPresenterActivity";
    }
}
