...
@Identifier("DSLEditor")
@AssociatedResources({
    org.kie.guvnor.dsltext.client.type.DSLResourceType.class
})
 ...
 */
public class DSLEditorPresenterActivity extends AbstractWorkbenchEditorActivity {
    ...
    @Inject
    private DSLEditorPresenter realPresenter;

    @Inject
    //Constructor injection for testing
    public DSLEditorPresenterActivity(final PlaceManager placeManager) {
        super( placeManager );
    }
    ...
    public String getSignatureId() {
        return "org.kie.guvnor.dsltext.client.editor.DSLEditorPresenterActivity";
    }
}
