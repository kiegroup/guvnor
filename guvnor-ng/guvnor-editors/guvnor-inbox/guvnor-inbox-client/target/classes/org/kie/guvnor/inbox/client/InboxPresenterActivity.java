 ...
 */
public class InboxPresenterActivity extends AbstractWorkbenchScreenActivity {
    ...
    @Inject
    private InboxPresenter realPresenter;

    @Inject
    //Constructor injection for testing
    public InboxPresenterActivity(final PlaceManager placeManager) {
        super( placeManager );
    }
    ...
    public String getSignatureId() {
        return "org.kie.guvnor.inbox.client.InboxPresenterActivity";
    }
}
