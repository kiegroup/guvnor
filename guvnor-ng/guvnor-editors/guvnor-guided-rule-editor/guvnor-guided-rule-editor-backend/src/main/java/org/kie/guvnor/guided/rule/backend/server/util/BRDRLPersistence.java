...
public class BRDRLPersistence
    ...
    public RuleModel unmarshal( String str ) {
        RuleDescr ruleDescr = parseDrl(str);
        RuleModel m = new RuleModel();
        m.name = ruleDescr.getName();
        boolean isJavaDialect = parseAttributes(m, ruleDescr.getAttributes());
        Map<String, String> boundParams = parseLhs(m, ruleDescr.getLhs());
        parseRhs(m, (String) ruleDescr.getConsequence(), isJavaDialect, boundParams);
        return m;
    }
    ...
    private boolean parseAttributes(RuleModel m, Map<String, AttributeDescr> attributes) {
    ...
    private Map<String, String> parseLhs(RuleModel m, AndDescr lhs) {
    ...
    private IPattern parseBaseDescr(BaseDescr descr, Map<String, String> boundParams) {
    ...
    private IFactPattern parsePatternDescr(PatternDescr pattern, Map<String, String> boundParams) {
    ...
    private IFactPattern parsePatternSource(PatternDescr pattern, PatternSourceDescr patternSource, Map<String, String> boundParams) {
    ...
    private CompositeFactPattern parseExistentialElementDescr(ConditionalElementDescr conditionalDescr, Map<String, String> boundParams) {
    ...
    private void addPatternToComposite(ConditionalElementDescr conditionalDescr, CompositeFactPattern comp, Map<String, String> boundParams) {
    ...
    private void parseConstraint(FactPattern factPattern, ConditionalElementDescr constraint) {
    ...
    private void parseRhs(RuleModel m, String rhs, boolean isJavaDialect, Map<String, String> boundParams) {
    ...
    private PortableParameterDefinition buildPortableParameterDefinition(String name, String value, Map<String, String> boundParams) {
    ...
    private void addSettersToAction(Map<String, List<String>> setStatements, String variable, ActionFieldList action, boolean isJavaDialect) {
        addSettersToAction(setStatements.remove(variable), action, isJavaDialect);
    }

    private void addSettersToAction(List<String> setters, ActionFieldList action, boolean isJavaDialect) {
        if (setters != null) {
    ...
    private ActionFieldValue buildFieldValue(boolean isJavaDialect, String field, String value, String dataType) {
    ...
    private String inferDataType(String param, boolean isJavaDialect) {
    ...
    private String adjustParam(String dataType, String param, boolean isJavaDialect) {
    ...
    private String getStatementType(String fact, Map<String, String> factsType) {
        String type = null;
    ...
    private static class SimpleExpr implements Expr {
        ...
        private FieldConstraint asSingleFieldConstraint(String fieldName, String operator, String value) {
        ...
        private FieldConstraint asExpressionBuilderConstraint(FactPattern factPattern, String fieldName, String operator, String value) {
        ...
        private String setFieldBindingOnContraint(String fieldName, SingleFieldConstraint con) {
        ...
        private String setOperatorAndValueOnConstraint(String operator, String value, SingleFieldConstraint con) {
            if (operator != null) {
        ...
        private String setValueOnConstraint(String operator, BaseSingleFieldConstraint con, String value) {
            String type = null;
            if (value.startsWith("\"")) {
