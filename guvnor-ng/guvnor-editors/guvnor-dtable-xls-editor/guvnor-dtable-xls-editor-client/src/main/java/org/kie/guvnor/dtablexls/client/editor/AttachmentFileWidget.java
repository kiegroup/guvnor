...
public class AttachmentFileWidget extends Composite {
    ...
    protected void initWidgets() {
        ...
        final Button ok = new Button( DecisionTableXLSEditorConstants.INSTANCE.Upload() );
        ...
        form.addSubmitCompleteHandler( new SubmitCompleteHandler() {
            ...
            public void onSubmitComplete( SubmitCompleteEvent event ) {
                ...
                if ( "OK".equalsIgnoreCase( event.getResults() ) ) {
                    ...
                    Window.alert( DecisionTableXLSEditorConstants.INSTANCE.UploadFailure0( event.getResults() ) );
                }
            }
