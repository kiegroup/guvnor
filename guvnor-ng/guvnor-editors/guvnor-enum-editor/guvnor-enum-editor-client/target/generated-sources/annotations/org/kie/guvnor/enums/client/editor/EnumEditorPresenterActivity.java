...
@Identifier("EnumEditor")
@AssociatedResources({
    org.kie.guvnor.enums.client.type.EnumResourceType.class
})
 ...
 */
public class EnumEditorPresenterActivity extends AbstractWorkbenchEditorActivity {
    ...
    @Inject
    private EnumEditorPresenter realPresenter;

    @Inject
    //Constructor injection for testing
    public EnumEditorPresenterActivity(final PlaceManager placeManager) {
        super( placeManager );
    }
    ...
    public String getSignatureId() {
        return "org.kie.guvnor.enums.client.editor.EnumEditorPresenterActivity";
    }
}
