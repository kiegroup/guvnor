...
public class ScenarioEditorViewImpl
    ...
    @Override
    public void initImportsTab(DataModelOracle dmo, Imports imports, boolean readOnly) {
    ...
    @Override
    public void setScenario(String packageName, Scenario scenario, DataModelOracle dmo) {
