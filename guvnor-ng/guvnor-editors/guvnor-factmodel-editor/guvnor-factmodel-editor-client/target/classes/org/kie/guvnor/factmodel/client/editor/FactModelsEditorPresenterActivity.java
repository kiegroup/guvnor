...
@Identifier("FactModelsEditor")
@AssociatedResources({
    org.kie.guvnor.factmodel.client.type.FactModelResourceType.class
})
 ...
 */
public class FactModelsEditorPresenterActivity extends AbstractWorkbenchEditorActivity {
    ...
    @Inject
    private FactModelsEditorPresenter realPresenter;

    @Inject
    //Constructor injection for testing
    public FactModelsEditorPresenterActivity(final PlaceManager placeManager) {
        super( placeManager );
    }
    ...
    public String getSignatureId() {
        return "org.kie.guvnor.factmodel.client.editor.FactModelsEditorPresenterActivity";
    }
}
