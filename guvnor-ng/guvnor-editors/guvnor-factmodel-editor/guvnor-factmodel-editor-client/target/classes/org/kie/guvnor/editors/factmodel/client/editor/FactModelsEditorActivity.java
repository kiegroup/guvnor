...
@ResourceType("model.drl")
@Identifier("FactModelsEditor")
/*
 * WARNING! This class is generated. Do not modify.
 */
public class FactModelsEditorActivity extends AbstractWorkbenchEditorActivity {
    ...
    @Inject
    private FactModelsEditor realPresenter;

    @Inject
    //Constructor injection for testing
    public FactModelsEditorActivity(final PlaceManager placeManager) {
        super( placeManager );
    }
    ...
    public String getSignatureId() {
        return "org.kie.guvnor.editors.factmodel.client.editor.FactModelsEditorActivity";
    }
}
