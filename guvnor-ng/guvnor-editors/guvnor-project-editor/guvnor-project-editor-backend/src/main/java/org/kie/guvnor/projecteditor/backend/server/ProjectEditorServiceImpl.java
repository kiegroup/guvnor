...
public class ProjectEditorServiceImpl
    ...
    public Path newProject( final String name ) {
        ...
        return saveGav( getGav( name ), new GroupArtifactVersionModel() );
    }
    ...
    private Path getGav( String name ) {
        return paths.convert( ioService.get( "default://uf-playground/" + name + "/pom.xml" ) );
    }
}