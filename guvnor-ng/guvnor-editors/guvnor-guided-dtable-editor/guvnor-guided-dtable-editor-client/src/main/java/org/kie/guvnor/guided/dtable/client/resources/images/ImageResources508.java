...
public class ImageResources508 {
    ...
    public Image Edit() {
        Image image = new Image( ImageResources.INSTANCE.edit() );
        image.setAltText( Constants.INSTANCE.Edit() );
        return image;
    }

    public Image EditDisabled() {
        Image image = new Image( ImageResources.INSTANCE.editDisabled() );
        image.setAltText( Constants.INSTANCE.EditDisabled() );
        return image;
    }

    public Image Config() {
        Image image = new Image(ImageResources.INSTANCE.config());
        image.setAltText(Constants.INSTANCE.Config());
        return image;
    }

    public Image DeleteItemSmall() {
        Image image = new Image(ImageResources.INSTANCE.itemImages().deleteItemSmall());
    ...
    public Image NewItem() {
        Image image = new Image(ImageResources.INSTANCE.itemImages().newItem());
