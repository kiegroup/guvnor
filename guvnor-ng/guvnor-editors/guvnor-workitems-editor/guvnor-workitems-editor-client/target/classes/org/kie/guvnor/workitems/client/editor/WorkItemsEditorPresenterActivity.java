...
@Identifier("WorkItemsEditor")
@AssociatedResources({
    org.kie.guvnor.workitems.client.type.WorkItemsResourceType.class
})
 ...
 */
public class WorkItemsEditorPresenterActivity extends AbstractWorkbenchEditorActivity {
    ...
    @Inject
    private WorkItemsEditorPresenter realPresenter;

    @Inject
    //Constructor injection for testing
    public WorkItemsEditorPresenterActivity(final PlaceManager placeManager) {
        super( placeManager );
    }
    ...
    public String getSignatureId() {
        return "org.kie.guvnor.workitems.client.editor.WorkItemsEditorPresenterActivity";
    }
}
