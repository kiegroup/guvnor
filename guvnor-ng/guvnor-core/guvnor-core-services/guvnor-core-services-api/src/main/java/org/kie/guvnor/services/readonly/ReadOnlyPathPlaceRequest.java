...
public class ReadOnlyPathPlaceRequest
    ...
    public ReadOnlyPathPlaceRequest(Path path, Map<String, String> parameters) {
        super(path, parameters);
        addParameter("readOnly", "yes");
    }

    public ReadOnlyPathPlaceRequest(Path path, String id) {
        super(path, id);
        addParameter("readOnly", "yes");
    }

    public ReadOnlyPathPlaceRequest(Path path, String id, Map<String, String> parameters) {
