...
public class ProjectResource {
    ...
    private List<ProjectResponse> getProjectResponses(Collection<Project> projects) {
        final List<ProjectResponse> projectRequests = new ArrayList<>(projects.size());
        for (final Project project : projects) {
            final ProjectResponse projectReq = new ProjectResponse();
            final GAV projectGAV = project.getMainModule().getPom().getGav();
    ...
    public Collection<OrganizationalUnit> getOrganizationalUnits() {
        ...
        for (final org.guvnor.structure.organizationalunit.OrganizationalUnit ou : origOrgUnits) {
            ...
            for (final Project project : projectService.getAllProjects(ou)) {
    ...
    public OrganizationalUnit getOrganizationalUnit(@PathParam("organizationalUnitName") String organizationalUnitName) {
        ...
        for (final Project project : projectService.getAllProjects()) {
            if (project.getOrganizationalUnit().getName().equals(organizationalUnitName)) {
                projectNames.add(project.getName());
            }
        }
    ...
    private Project checkProjectExistence(String projectName) {
