...
public class ServiceConfigTest {
    ...
    final Collection<MavenArtifact> excludedArtifacts = new ArrayList<MavenArtifact>() {{
        add(new MavenArtifact("org.kie:knowledge-api:jar:5.5.0-SNAPSHOT:compile"));
        add(new MavenArtifact("org.kie:knowledge-api:jar:5.5.0-SNAPSHOT:compile"));
    ...
    public void testEquals() {
        ...
        serviceConfig.removeExcludedArtifact(new MavenArtifact("org.kie:knowledge-api:jar:5.5.0-SNAPSHOT:compile"));
        assertFalse(serviceConfig.equals(new ServiceConfig("70", excludedArtifacts, kbases)));
        assertFalse(serviceConfig.hashCode() == new ServiceConfig("70", excludedArtifacts, kbases).hashCode());
    ...
    public void testAddRemoveExcludedArtifacts() {
        ...
        serviceConfig.addExcludedArtifact(new MavenArtifact("org.kie:knowledge-api:jar:5.5.0-SNAPSHOT:compile"));
        serviceConfig.addExcludedArtifact(new MavenArtifact("org.kie:knowledge-api:jar:5.5.0-SNAPSHOT:compile"));
        ...
        serviceConfig.removeExcludedArtifact(new MavenArtifact("org.kie:knowledge-api:jar:5.5.0-SNAPSHOT:compile"));
        serviceConfig.removeExcludedArtifact(new MavenArtifact("org.kie:knowledge-aaaapi:jar:5.5.0-SNAPSHOT:compile"));
        ...
        serviceConfig.addExcludedArtifact(new MavenArtifact("org.kie:knowledge-aaaapi:jar:5.5.0-SNAPSHOT:compile"));
