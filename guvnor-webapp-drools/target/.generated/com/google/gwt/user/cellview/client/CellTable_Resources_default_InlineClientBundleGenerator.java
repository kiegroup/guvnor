  ...
  private void cellTableStyleInitializer() {
    cellTableStyle = new com.google.gwt.user.cellview.client.CellTable.Style() {
      ...
      public String getText() {
        return com.google.gwt.i18n.client.LocaleInfo.getCurrentLocale().isRTL() ? ((".GEI-42ID{border-top:" + ("2px"+ " " +"solid"+ " " +"#6f7277")  + ";padding:" + ("3px"+ " " +"15px")  + ";text-align:" + ("right")  + ";color:" + ("#4b4a4a")  + ";text-shadow:" + ("#ddf"+ " " +"1px"+ " " +"1px"+ " " +"0")  + ";overflow:" + ("hidden")  + ";}.GEI-42JD{border-bottom:" + ("2px"+ " " +"solid"+ " " +"#6f7277")  + ";padding:" + ("3px"+ " " +"15px")  + ";text-align:" + ("right")  + ";color:" + ("#4b4a4a")  + ";text-shadow:") + (("#ddf"+ " " +"1px"+ " " +"1px"+ " " +"0")  + ";overflow:" + ("hidden")  + ";}.GEI-42CD{padding:" + ("2px"+ " " +"15px")  + ";overflow:" + ("hidden")  + ";}.GEI-42HE{cursor:" + ("pointer")  + ";cursor:" + ("hand")  + ";}.GEI-42HE:hover{color:" + ("#6c6b6b")  + ";}.GEI-42DD{background:" + ("#fff")  + ";}.GEI-42ED{border:" + ("2px"+ " " +"solid"+ " " +"#fff")  + ";}.GEI-42DE{background:" + ("#f3f7fb")  + ";}.GEI-42EE{border:" + ("2px"+ " " +"solid"+ " " +"#f3f7fb") ) + (";}.GEI-42KD{background:" + ("#eee")  + ";}.GEI-42LD{border:" + ("2px"+ " " +"solid"+ " " +"#eee")  + ";}.GEI-42ND{background:" + ("#ffc")  + ";}.GEI-42OD{border:" + ("2px"+ " " +"solid"+ " " +"#ffc")  + ";}.GEI-42FE{background:" + ("#628cd5")  + ";color:" + ("white")  + ";height:" + ("auto")  + ";overflow:" + ("auto")  + ";}.GEI-42GE{border:" + ("2px"+ " " +"solid"+ " " +"#628cd5")  + ";}.GEI-42MD{border:" + ("2px"+ " " +"solid"+ " " +"#d7dde8")  + ";}.GEI-42CE{margin:") + (("30px")  + ";}")) : ((".GEI-42ID{border-top:" + ("2px"+ " " +"solid"+ " " +"#6f7277")  + ";padding:" + ("3px"+ " " +"15px")  + ";text-align:" + ("left")  + ";color:" + ("#4b4a4a")  + ";text-shadow:" + ("#ddf"+ " " +"1px"+ " " +"1px"+ " " +"0")  + ";overflow:" + ("hidden")  + ";}.GEI-42JD{border-bottom:" + ("2px"+ " " +"solid"+ " " +"#6f7277")  + ";padding:" + ("3px"+ " " +"15px")  + ";text-align:" + ("left")  + ";color:" + ("#4b4a4a")  + ";text-shadow:") + (("#ddf"+ " " +"1px"+ " " +"1px"+ " " +"0")  + ";overflow:" + ("hidden")  + ";}.GEI-42CD{padding:" + ("2px"+ " " +"15px")  + ";overflow:" + ("hidden")  + ";}.GEI-42HE{cursor:" + ("pointer")  + ";cursor:" + ("hand")  + ";}.GEI-42HE:hover{color:" + ("#6c6b6b")  + ";}.GEI-42DD{background:" + ("#fff")  + ";}.GEI-42ED{border:" + ("2px"+ " " +"solid"+ " " +"#fff")  + ";}.GEI-42DE{background:" + ("#f3f7fb")  + ";}.GEI-42EE{border:" + ("2px"+ " " +"solid"+ " " +"#f3f7fb") ) + (";}.GEI-42KD{background:" + ("#eee")  + ";}.GEI-42LD{border:" + ("2px"+ " " +"solid"+ " " +"#eee")  + ";}.GEI-42ND{background:" + ("#ffc")  + ";}.GEI-42OD{border:" + ("2px"+ " " +"solid"+ " " +"#ffc")  + ";}.GEI-42FE{background:" + ("#628cd5")  + ";color:" + ("white")  + ";height:" + ("auto")  + ";overflow:" + ("auto")  + ";}.GEI-42GE{border:" + ("2px"+ " " +"solid"+ " " +"#628cd5")  + ";}.GEI-42MD{border:" + ("2px"+ " " +"solid"+ " " +"#d7dde8")  + ";}.GEI-42CE{margin:") + (("30px")  + ";}"));
      }
