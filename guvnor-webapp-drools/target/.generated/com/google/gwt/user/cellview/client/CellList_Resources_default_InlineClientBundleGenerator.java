  ...
  private void cellListStyleInitializer() {
    cellListStyle = new com.google.gwt.user.cellview.client.CellList.Style() {
      ...
      public String getText() {
        return (".GEI-42EB,.GEI-42GB{cursor:" + ("pointer")  + ";zoom:" + ("1")  + ";}.GEI-42FB{background:" + ("#ffc")  + ";}.GEI-42HB{height:" + ((CellList_Resources_default_InlineClientBundleGenerator.this.cellListSelectedBackground()).getHeight() + "px")  + ";overflow:" + ("hidden")  + ";background:" + ("url(\"" + (CellList_Resources_default_InlineClientBundleGenerator.this.cellListSelectedBackground()).getURL() + "\") -" + (CellList_Resources_default_InlineClientBundleGenerator.this.cellListSelectedBackground()).getLeft() + "px -" + (CellList_Resources_default_InlineClientBundleGenerator.this.cellListSelectedBackground()).getTop() + "px  repeat-x")  + ";background-color:" + ("#628cd5")  + ";color:" + ("white")  + ";height:" + ("auto")  + ";overflow:" + ("visible")  + ";}");
      }
