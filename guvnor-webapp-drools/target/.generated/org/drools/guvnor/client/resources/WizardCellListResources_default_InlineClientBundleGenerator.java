  ...
  private void cellListStyleInitializer() {
    cellListStyle = new org.drools.guvnor.client.resources.WizardCellListResources.WizardCellListStyle() {
      ...
      public String getText() {
        return (".GEI-42GL{width:" + ("250px")  + ";overflow:" + ("hidden")  + ";padding:" + ("2px")  + ";}.GEI-42CL{padding:" + ("1px")  + ";margin-bottom:" + ("1px")  + ";cursor:" + ("pointer")  + ";zoom:" + ("1")  + ";}.GEI-42BL{padding:" + ("1px")  + ";cursor:" + ("pointer")  + ";color:" + ("#969696")  + ";font-style:") + (("italic")  + ";zoom:" + ("1")  + ";}.GEI-42EL{padding:" + ("1px")  + ";margin-bottom:" + ("1px")  + ";cursor:" + ("pointer")  + ";zoom:" + ("1")  + ";}.GEI-42DL{background:" + ("#ffc")  + ";}.GEI-42FL{background-color:" + ("#c8c8c8")  + ";}");
      }
