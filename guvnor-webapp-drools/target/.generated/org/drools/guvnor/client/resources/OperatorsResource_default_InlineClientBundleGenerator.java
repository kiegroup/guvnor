  ...
  private void operatorsCssInitializer() {
    operatorsCss = new org.drools.guvnor.client.resources.OperatorsCss() {
      ...
      public String getText() {
        return com.google.gwt.i18n.client.LocaleInfo.getCurrentLocale().isRTL() ? ((".GEI-42KJ{padding:" + ("0")  + ";padding:" + ("0")  + ";}.GEI-42LJ{width:" + ("25px")  + ";margin-left:" + ("1px")  + ";font-size:" + ("smaller")  + ";}")) : ((".GEI-42KJ{padding:" + ("0")  + ";padding:" + ("0")  + ";}.GEI-42LJ{width:" + ("25px")  + ";margin-right:" + ("1px")  + ";font-size:" + ("smaller")  + ";}"));
      }
