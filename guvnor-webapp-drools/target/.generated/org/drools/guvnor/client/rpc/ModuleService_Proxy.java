...
public class ModuleService_Proxy extends RemoteServiceProxy implements org.drools.guvnor.client.rpc.ModuleServiceAsync {
  ...
  private static final String SERIALIZATION_POLICY ="8497969E2348687B49747F23DD6D4BF7";
  ...
  public void runScenario(java.lang.String p0, org.drools.ide.common.client.modeldriven.testing.Scenario p1, com.google.gwt.user.client.rpc.AsyncCallback cb) {
    RpcStatsContext statsContext = new RpcStatsContext();
    ...
    try {
      ...
      streamWriter.writeInt(2);
      streamWriter.writeString("java.lang.String/2004016611");
      streamWriter.writeString("org.drools.ide.common.client.modeldriven.testing.Scenario/3601385176");
      streamWriter.writeString(p0);
  ...
  public void saveModule(org.drools.guvnor.client.rpc.Module p0, com.google.gwt.user.client.rpc.AsyncCallback cb) {
    ...
    try {
      ...
      streamWriter.writeInt(1);
      streamWriter.writeString("org.drools.guvnor.client.rpc.Module/3987908514");
      streamWriter.writeObject(p0);
      String payload = streamWriter.toString();
