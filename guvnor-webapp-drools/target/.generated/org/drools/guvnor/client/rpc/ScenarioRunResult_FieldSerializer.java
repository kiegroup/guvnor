...
public class ScenarioRunResult_FieldSerializer implements com.google.gwt.user.client.rpc.impl.TypeHandler {
  ...
  private static native org.drools.ide.common.client.modeldriven.testing.Scenario getScenario(org.drools.guvnor.client.rpc.ScenarioRunResult instance) /*-{
    return instance.@org.drools.guvnor.client.rpc.ScenarioRunResult::scenario;
  }-*/;
  
  private static native void setScenario(org.drools.guvnor.client.rpc.ScenarioRunResult instance, org.drools.ide.common.client.modeldriven.testing.Scenario value) 
  /*-{
  ...
  public static void deserialize(SerializationStreamReader streamReader, org.drools.guvnor.client.rpc.ScenarioRunResult instance) throws SerializationException {
    ...
    setScenario(instance, (org.drools.ide.common.client.modeldriven.testing.Scenario) streamReader.readObject());
