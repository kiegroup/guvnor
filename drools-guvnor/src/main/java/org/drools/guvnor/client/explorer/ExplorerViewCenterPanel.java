...
public class ExplorerViewCenterPanel {
    ...
    public void openAssets(String[] uuids) {
        ...
        RepositoryServiceFactory.getService().loadRuleAssets( uuids,
                                                              new GenericCallback<RuleAsset[]>() {
                                                                  public void onSuccess(final RuleAsset[] assets) {
                                                                      loading[0] = false;
                                                                      if ( assets != null && assets.length > 1 ) SuggestionCompletionCache.getInstance().doAction( assets[1].metaData.packageName,
                                                                                           new Command() {
                                                                                               public void execute() {
                                                                                                   LoadingPopup.close();
                                                                                                   final String[] names = new String[assets.length];
                                                                                                   final String[] uuids = new String[assets.length];
                                                                                                   String blockingAssetName = null;
                                                                                                   for ( int i = 0; i < assets.length; i++ ) {
                                                                                                       // Check if any of these assets are already opened.
                                                                                                       if (showIfOpen(assets[i].uuid)) {
                                                                                                           blockingAssetName=assets[i].metaData.name;
                                                                                                           break;
                                                                                                       }
                                                                                                       names[i] = assets[i].metaData.name;
                                                                                                       uuids[i] = assets[i].uuid;
                                                                                                   }
                                                                                                   ...
                                                                                                   MultiViewEditor multiview = new MultiViewEditor( assets,
                                                                                                                                                    new EditItemEvent() {
                                                                                                                                                        public void open(String key) {
                                                                                                                                                            openAsset( key );
                                                                                                                                                        }
