...
import org.kie.guvnor.guided.model.analysis.AnalysisReportLine;
...
//
//        MessageBuilder.createCall( new RemoteCallback<RuleModel>() {
//            public void callback( final RuleModel response ) {
//                RuleModeller.this.model = response;
//                doLayout();
//            }
//        }, GuidedEditorService.class ).loadModel( path );
//    }
    ...
    public DataModel getSuggestionCompletions() {
    ...
    public void verifyRule( final Command cmd,
        ...
        Set<WorkingSetConfigData> activeWorkingSets = WorkingSetManager.getInstance().getActiveWorkingSets( path );
        ...
        }, GuidedEditorService.class ).verifyAssetWithoutVerifiersRules( this.model, activeWorkingSets );
    }
