...
import org.kie.guvnor.datamodel.DSLComplexVariableValue;
import org.kie.guvnor.datamodel.DSLSentence;
import org.kie.guvnor.datamodel.DSLVariableValue;
...
import org.kie.guvnor.guided.client.editor.CustomFormPopUp;
import org.kie.guvnor.guided.client.editor.EnumDropDown;
...
public class DSLSentenceWidget extends RuleModellerWidget {
     ...
     * result of
     * {@link #getBox(org.drools.ide.common.client.modeldriven.brl.DSLVariableValue, String) }
     * is returned.
     * @param variableDef
     * @param value
     * @return
    ...
    public Widget getCustomFormEditor( String variableDef,
        ...
        final CustomFormConfiguration customFormConfiguration = WorkingSetManager.
                getInstance().getCustomFormConfiguration( this.getModeller().getPath(),
                                                          factType,
                                                          field );
    ...
    class DSLDropDown extends DirtyableComposite
        ...
        final DataModel completions = getModeller().getSuggestionCompletions();
