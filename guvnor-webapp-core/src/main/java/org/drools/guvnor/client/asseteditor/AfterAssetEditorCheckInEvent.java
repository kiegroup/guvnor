...
public class AfterAssetEditorCheckInEvent extends GwtEvent<AfterAssetEditorCheckInEvent.Handler> {
    ...
    /**
     * The editor that performed the check-in. The only known case where this
     * editor is null is for {@link VersionBrowser}. This is because this class
     * is not an instance of GuvnorEditor.
     */
    private final GuvnorEditor        editor;

    public AfterAssetEditorCheckInEvent(String uuid,
                                        GuvnorEditor editor) {
        this.uuid = uuid;
        this.editor = editor;
    }
