...
public abstract class DirtyableComposite extends Composite implements
     ...
     * (non-Javadoc)
     *
     * @see org.kie.guvnor.client.common.isDirtable#isDirty()
     */
     ...
     * (non-Javadoc)
     *
     * @see org.kie.guvnor.client.common.isDirtable#resetDirty()
     */
     ...
     * (non-Javadoc)
     *
     * @see org.kie.guvnor.client.common.isDirtable#makeDirty()
     */
