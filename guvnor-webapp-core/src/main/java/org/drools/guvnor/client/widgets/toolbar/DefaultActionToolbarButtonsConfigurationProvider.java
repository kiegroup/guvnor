...
public class DefaultActionToolbarButtonsConfigurationProvider
    ...
    public static String[]  VALIDATING_FORMATS = new String[]{BUSINESS_RULE, DSL_TEMPLATE_RULE, DECISION_SPREADSHEET_XLS, DRL, ENUMERATION, DECISION_TABLE_GUIDED, DRL_MODEL, DSL, FUNCTION, RULE_TEMPLATE, SPRING_CONTEXT, SERVICE_CONFIG, SCORECARD_SPREADSHEET_XLS, SCORECARD_GUIDED};
    private static String[] SOURCE_FORMATS     = new String[]{BUSINESS_RULE, DSL_TEMPLATE_RULE, DRL, DRL_MODEL, DECISION_SPREADSHEET_XLS, DECISION_TABLE_GUIDED, RULE_TEMPLATE, BPMN2_PROCESS, BPMN_PROCESS, SCORECARD_SPREADSHEET_XLS, SCORECARD_GUIDED};
