...
public class AdminArchivedPagedTable extends AbstractAssetPagedTable<AdminArchivedPageRow> {
    ...
    protected void addAncillaryColumns(ColumnPicker<AdminArchivedPageRow> columnPicker,
        ...
        Column<AdminArchivedPageRow, ComparableImageResource> formatColumn = new Column<AdminArchivedPageRow, ComparableImageResource>( new ComparableImageResourceCell() ) {
        ...
        columnPicker.addColumn( formatColumn,
                                new SortableHeader<AdminArchivedPageRow, ComparableImageResource>(
                                                                                                   sortableHeaderGroup,
                                                                                                   constants.Format(),
                                                                                                   formatColumn ),
                                true );
