 ...
 */
package org.guvnor.ala.registry.tests;
 ...
 */
public class PageSortUtilsTest {
    ...
    public void pipelinesPagingAndSorting() {
        ...
        List<Pipeline> pageSort = PageSortUtils.pageSort(pipes,
        ...
        pageSort = PageSortUtils.pageSort(pipes,
                                          (Pipeline p1, Pipeline p2) -> {
                                              switch (sort) {
                                                  case "name":
                                                      return p1.getName().compareTo(p2.getName());
