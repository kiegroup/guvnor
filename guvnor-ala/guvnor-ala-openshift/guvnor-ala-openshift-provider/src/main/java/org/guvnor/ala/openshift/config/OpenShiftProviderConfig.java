...
public interface OpenShiftProviderConfig extends ProviderConfig {
    ...
    default String getKubeconfig() {
        return OpenShiftProperty.KUBECONFIG.inputExpression();
    }
    */

    /*
    default String getKubenamespace() {
        return OpenShiftProperty.KUBENAMESPACE.inputExpression();
    }
    */
    ...
    /*
    default String getKubernetesAuthTryKubeConfig() {
        return OpenShiftProperty.KUBERNETES_AUTH_TRY_KUBE_CONFIG.inputExpression();
    }
    */

    /*
    default String getKubernetesAuthTryServiceAccount() {
        return OpenShiftProperty.KUBERNETES_AUTH_TRY_SERVICE_ACCOUNT.inputExpression();
    }
    */
    ...
    /*
    default String getKubernetesTryNamespacePath() {
        return OpenShiftProperty.KUBERNETES_TRY_NAMESPACE_PATH.inputExpression();
    }
    */
