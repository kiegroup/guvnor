...
public enum OpenShiftProperty {
    ...
    /* ---------- Kubernetes + OpenShift properties ---------- */
    ALL_PROXY(Config.KUBERNETES_ALL_PROXY),
    HTTP_PROXY(Config.KUBERNETES_HTTP_PROXY),
    HTTPS_PROXY(Config.KUBERNETES_HTTPS_PROXY),
    //KUBECONFIG(Config.KUBERNETES_KUBECONFIG_FILE),
    //KUBENAMESPACE(Config.KUBERNETES_NAMESPACE_FILE),
    ...
    //KUBERNETES_AUTH_TRY_KUBE_CONFIG(Config.KUBERNETES_AUTH_TRYKUBECONFIG_SYSTEM_PROPERTY),
    //KUBERNETES_AUTH_TRY_SERVICE_ACCOUNT(Config.KUBERNETES_AUTH_TRYSERVICEACCOUNT_SYSTEM_PROPERTY),
    ...
    //KUBERNETES_TRY_NAMESPACE_PATH(Config.KUBERNETES_TRYNAMESPACE_PATH_SYSTEM_PROPERTY),
    ...
    /* ---------- Additional properties for Guvnor ALA ---------- */
