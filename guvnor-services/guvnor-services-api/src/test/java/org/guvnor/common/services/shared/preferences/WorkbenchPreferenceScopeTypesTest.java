...
public class WorkbenchPreferenceScopeTypesTest {
    ...
    public void typesRequireKeyTest() {
        assertFalse( scopeTypes.typeRequiresKey( WorkbenchPreferenceScopes.GLOBAL.type() ) );
        assertFalse( scopeTypes.typeRequiresKey( WorkbenchPreferenceScopes.USER.type() ) );
        assertTrue( scopeTypes.typeRequiresKey( WorkbenchPreferenceScopes.PROJECT.type() ) );
    }

    @Test
    public void defaultKeysForTypesTest() {
        assertEquals( WorkbenchPreferenceScopes.GLOBAL.type(), scopeTypes.getDefaultKeyFor( WorkbenchPreferenceScopes.GLOBAL.type() ) );
        assertEquals( "admin", scopeTypes.getDefaultKeyFor( WorkbenchPreferenceScopes.USER.type() ) );
    }

    @Test(expected = InvalidPreferenceScopeException.class)
    public void defaultKeysForTypesThatDoNotHaveDefaultKeysTest() {
        scopeTypes.getDefaultKeyFor( WorkbenchPreferenceScopes.PROJECT.type() );
    }
