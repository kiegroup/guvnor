...
public class WorkbenchPreferenceScopeResolutionStrategiesImpl implements WorkbenchPreferenceScopeResolutionStrategies {
    ...
    public PreferenceScopeResolutionStrategyInfo getInfo( final WorkbenchPreferenceScopes scope,
                                                          final String key ) {
        PreferenceScopeResolutionStrategy scopeResolutionStrategy = new WorkbenchPreferenceScopeResolutionStrategy( scopeFactory,
                                                                                                                    scope,
                                                                                                                    key );
