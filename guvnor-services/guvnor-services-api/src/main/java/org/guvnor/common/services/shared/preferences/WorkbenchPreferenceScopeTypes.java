...
public class WorkbenchPreferenceScopeTypes implements PreferenceScopeTypes {
    ...
    public WorkbenchPreferenceScopeTypes( final UsernameProvider usernameProvider ) {
        ...
        defaultKeyByType.put( WorkbenchPreferenceScopes.GLOBAL.type(),
                              WorkbenchPreferenceScopes.GLOBAL::type );
        defaultKeyByType.put( WorkbenchPreferenceScopes.PROJECT.type(),
                              null );
        defaultKeyByType.put( WorkbenchPreferenceScopes.USER.type(),
