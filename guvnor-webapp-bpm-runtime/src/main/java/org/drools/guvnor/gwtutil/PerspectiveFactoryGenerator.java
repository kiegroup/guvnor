...
import org.drools.guvnor.client.resources.BpmRuntimeImages;
...
public class PerspectiveFactoryGenerator extends Generator {
    public String generate(TreeLogger logger, GeneratorContext context,
        ...
        composerFactory.addImport(ConstantsCore.class.getCanonicalName());
    ...
    private void generateAttributes(SourceWriter sourceWriter) {
        ...
        sourceWriter.println("private static ConstantsCore constants = GWT.create(ConstantsCore.class);");
    }
    ...
    private void generateGetRegisteredPerspectiveTypesMethod(SourceWriter sourceWriter, Map<String, List<ModuleEditorConfiguration>> registeredEditors) {
        ...
        sourceWriter.indent();
        sourceWriter.println("String[] formats = new String[] {\"runtime\"};");
